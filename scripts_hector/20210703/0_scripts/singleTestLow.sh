...
artic minion --normalise 200 --threads 32 --scheme-directory ${SCHEMES} --read-file genomes_${b}.fastq --fast5-directory ${FAST5_DIR} --sequencing-summary ${SEQSUM} nCoV-2019/V3 ${b} --bwa --threads 24 --skip-nanopolish >& ${b}_minion.log
