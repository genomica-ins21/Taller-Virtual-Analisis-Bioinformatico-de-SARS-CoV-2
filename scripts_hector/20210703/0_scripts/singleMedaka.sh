...
artic minion --medaka --medaka-model r941_min_high --normalise 200 --threads 32 --scheme-directory ${SCHEMES} --read-file genomes_${b}.fastq nCoV-2019/V3 ${b} --bwa >& ${b}_minion.log
