...
artic minion --normalise 200 --threads 32 --scheme-directory ${SCHEMES} --read-file genomes_${b}.fastq --fast5-directory ${FAST5_DIR} --sequencing-summary ${SEQSUM} nCoV-2019/V3 ${b} >& ${b}_minion.log
