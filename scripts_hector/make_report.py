...
metrics_df['Cobertura'] = metrics_df.eval('bases/29903')
...
merged_df = merged_df[['Cod.','ID','Linaje','scorpio_call','scorpio_support','Fecha secuencia','barcode','Procedencia','Fecha muestra','Deleciones','Inserciones','aaSustituciones','Cobertura','Profundidad','Observaciones']]
